...
const Section = () => {
  return (
    ...
    <div className="container mx-auto flex-row  flex justify-center items-center w-[28em]">
            <div><h2 className="text-[2.8em] text-[#F17B2C] leading-[40px] font-serif font-medium">financial</h2></div> 
            <div><img src='/text2.svg' alt="My descriptive image text" className='mt-2' /></div>  
            <div><h2 className="text-[2.8em] text-[#F17B2C] leading-[40px] font-serif font-medium">future.</h2></div>
    </div>
    </>
